    ...
    <div>
      <div className="grid grid-cols-[32px_minmax(137px,_1fr)_32px] items-center justify-between gap-4 px-4 py-6">
        ...
        <div className="flex justify-center items-center">
          <div className="w-full max-w-[137px] h-[5px] bg-sacramentoState-10 rounded-full after:w-[50px] after:h-[5px] after:bg-[#3BEDB2] after:rounded-full after:block">
          </div>
        </div>
      </div>
                  ...
                  <div key={qIndex}>
                    ...
                    {q.answer?.map((ans, ansIndex) => (
                      ...
                      <input
                        type="text"
                        placeholder={ans}
                        className="focus:outline-none w-full pb-2 border-b-2 border-sacramentoState text-sacramentoState placeholder:sacramentoState-80"
                      />
                    ))}
                  </div>
                ))}
