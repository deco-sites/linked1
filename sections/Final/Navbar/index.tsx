        ...
        <>
            <div>
                <nav
                    role="navigation"
                    id="nav"
                    className="inline-flex px-4 md:px-10 py-6 w-full justify-between items-center bg-sacramentoState border-b border-white-20 relative top-0 left-0 z-50"
                >
                    ...
                    <div className="w-fit md:hidden flex items-center">
                        ...
                        >
                            ...
                            <div
                                id="close-icon"
                                className="absolute top-0 left-0 duration-500 opacity-0"
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="32"
                    ...
                    <div
                        id="menu"
                        className="hidden md:block 2xl:flex space-x-4 font-sans text-white font-light items-center whitespace-nowrap"
                    >
                        {menu?.map((item, index) => (
                    ...
                    <div className="hidden md:block w-fit md:flex ml-8 bg-secondary rounded-xl items-center justify-center">
                        {button?.slice(0, 1).map((btn, index) => (
                            <ButtonComponent
                                key={index}
                                text={btn.text}
                                link={btn.link}
                ...
                <div
                    id="mobile-menu"
                    className="md:absolute fixed -translate-y-full duration-500 top-0 left-0 w-full h-screen bg-white md:bg-sacramentoState z-50 overflow-scroll z-[49]"
                >
                    <div className="md:pt-10 p-4 grid gap-6 md:flex min-h-screen md:min-h-0 overflow-auto">
                        <div className="md:mb-[184px] md:h-fit md:w-full grid md:grid-cols-2 md:gap-x-[28px]">
                            {menu?.map((item, index) => (
                                <a
                                    key={index}
                                    href={item.url}
                                    className="flex justify-between py-[22px] md:py-8 md:text-white border-b border-sacramentoState-10 md:border-white-20"
                                >
                                    {item.name}
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div className="md:w-[464px] md:h-fit grid gap-4 md:whitespace-nowrap">
                    ...
                    <div className="md:relative md:bottom-0 md:pl-4 md:flex grid gap-8 py-8 pb-10 md:text-darkMintCream">
