...
export default function Section({ 
  ...
  return (
    <section className="grid gap-8 lg:gap-20 pb-[65px] bg-white">
      <div>
        {/* Título para mobile */}
        <p className="pt-[52px] md:hidden pl-[17px] pb-[42px] font-sans font-semibold text-sacramentoState text-[22px] leading-tight-25 tracking-tight-2 text-left">
          {titleForMobile}
        </p>
        {/* Título para desktop */}
        <p className="pt-[144px] px-[240px] hidden md:block font-sans font-semibold text-sacramentoState text-5xl font-semibold leading-tight-55 tracking-tight-2 text-center">
          {titleForDesktop}
        </p>
